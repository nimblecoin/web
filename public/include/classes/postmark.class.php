...
$postmark->setDebug($debug);
$postmark->setMysql($mysqli);
$postmark->setSmarty($smarty);
$postmark->setConfig($config);
$postmark->setSetting($setting);
$postmark->setErrorCodes($aErrorCodes);
?>