          ...
          <tbody>
            ...
            {section contrib $CONTRIBHASHES}
                  ...
                  <tr{if $GLOBAL.userdata.username|default:""|lower == $CONTRIBHASHES[contrib].account|lower}{assign var=listed value=1} class="owned" {else} class="{cycle values="odd,even"}"{/if}>
                    ...
                    <td align="right">{if $CONTRIBHASHES[contrib].donate_percent > 0}<i class="fa fa-star tip" data-toggle="tooltip" title="SUPER AWESOME DONATOR" data-placement="right"></i>{/if}</td>
            ...
            {if $listed != 1 && $GLOBAL.userdata.username|default:""}
                  ...
                  <tr class="owned">
                    ...
                    <td>{if $GLOBAL.userdata.donate_percent > 0}<i class="fa fa-star tip" data-toggle="tooltip" title="SUPER AWESOME DONATOR" data-placement="right"></i>{/if}</td>
